    ...
    <div class="navbar navbar-default account" role="navigation">
        ...
        <div class="navbar-collapse collapse sidebar-navbar-collapse-account">
            <ul class="nav navbar-nav account">
                <li class="active"><a href="/account/index">Profile</a></li>
                <li id="account-repository"><a href="/account/repositories">My Repositories</a></li>
                <li><a href="/account/settings">Account settings</a></li>
                <li><a href="/account/messages">Messages <span class="badge">2</span></a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</div>