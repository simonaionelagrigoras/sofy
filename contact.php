...
<!--                <br />-->
                <div class="contact-form">
                    <input id="nume" type="text" placeholder="Nume complet" />
                    <input id="email" type="text" placeholder="Email" />
                    <textarea id="nume" type="text" placeholder="Nume complet">Mesaj:</textarea>
                    <input id="submit" id="submit" type="button" value="Trimite mesajul">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="mapouter">
                    <div class="gmap_canvas">
                        <iframe width="400" height="400" id="gmap_canvas" src="https://maps.google.com/maps?q=facultatea%20informatica%20iasi&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
